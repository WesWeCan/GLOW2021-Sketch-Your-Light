...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.546071538499518, 154.196947536985306, 8.907856923000963, 11.076693161323533 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.0, 492.032104000000004, 34.0, 36.167603 ],
					"proportion" : 0.39,
					"shape" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 425.0, 71.0, 22.0 ],
					"text" : "pack read s"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 551.0, 147.735294117647072, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"blinkcolor" : [ 0.827450980392157, 0.674509803921569, 0.674509803921569, 1.0 ],
					"id" : "obj-9",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.2, 0.992156862745098, 0.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 519.0, 147.735294117647072, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_longname" : "button[121]",
							"parameter_mmax" : 1,
							"parameter_shortname" : "button[119]",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 491.0, 91.0, 22.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 553.5, 186.235294117647072, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.0, 425.0, 72.0, 22.0 ],
					"text" : "pack write s"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-10",
					"items" : [ "Kies", ",", "SW1", ",", "SW2", ",", "SW3", ",", "SW4", ",", "SW5", ",", "SW6", ",", "SW7", ",", "SW8", ",", "SW9", ",", "SW10", ",", "PR1", ",", "PR2", ",", "PR3", ",", "PR4", ",", "OFF" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 449.5, 164.735294117647072, 63.084905594587326, 23.0 ],
					"pattrmode" : 1,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							...
							"parameter_enum" : [ "Kies", "SW1", "SW2", "SW3", "SW4", "SW5", "SW6", "SW7", "SW8", "SW9", "SW10", "PR1", "PR2", "PR3", "PR4", "OFF" ]
						}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 519.0, 175.73529400000001, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_longname" : "button[119]",
							"parameter_mmax" : 1,
							"parameter_shortname" : "button[119]",
							"parameter_enum" : [ "off", "on" ]
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.0, 417.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 481.0, 74.0, 22.0 ],
					"text" : "s ReadWrite"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.0, 445.0, 34.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.600000143051147, 230.335294621450544, 35.0, 27.0 ],
					"text" : "5",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 272.100000580352798, 221.335294503803482, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 311.999994000000015, 200.0, 35.0, 27.0 ],
					"text" : "4",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 308.499994437301666, 191.999999882352938, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 160.735294117647072, 35.0, 27.0 ],
					"text" : "2",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 257.500000437301651, 152.73529400000001, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 190.735294117647072, 35.0, 27.0 ],
					"text" : "1",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 231.0, 183.235294117647072, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.499993562698364, 259.335294621450544, 35.0, 27.0 ],
					"text" : "3",
					"textcolor" : [ 0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 311.999994000000015, 251.335294503803482, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -46.000000387430191, 34.0, 633.000000774860382, 411.419867212603606 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 481.042452797293663, 414.0, 639.5, 414.0 ],
					"order" : 1,
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 481.042452797293663, 414.0, 724.5, 414.0 ],
					"order" : 0,
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 240.5, 400.0, 117.499993562698364, 400.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 267.000000437301651, 400.0, 186.5, 400.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 317.999994437301666, 402.0, 319.999993562698364, 402.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 281.600000580352798, 401.0, 387.999993562698364, 401.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 560.5, 417.0, 672.5, 417.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 563.0, 412.0, 586.5, 412.0 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 672.5, 474.0, 499.5, 474.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 321.499994000000015, 400.0, 254.5, 400.0 ],
					"source" : [ "obj-6", 0 ]
				}
